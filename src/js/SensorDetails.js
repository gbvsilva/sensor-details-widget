    ...
    var SensorDetails = function SensorDetails() {
        ...
        var showStatusFromFieldElement = (current_status) => {
            ...
            if (entityInfo.type === "Sensor") {
                ...
                sensorESP_periodoA.innerHTML = (parseFloat(entityInfo.periodo_A)) ? (entityInfo.periodo_A+" Hz") : "n/a";
                sensorESP_periodoB.innerHTML = (parseFloat(entityInfo.periodo_B)) ? (entityInfo.periodo_B+" Hz") : "n/a";
                sensorESP_periodoC.innerHTML = (parseFloat(entityInfo.periodo_C)) ? (entityInfo.periodo_C+" Hz") : "n/a";
                ...
                sensorESP_voltagemTHDA.innerHTML = (parseFloat(entityInfo.voltagem_THD_A)) ? (parseFloat(entityInfo.voltagem_THD_A).toFixed(2)+" V") : "n/a";
                sensorESP_voltagemTHDB.innerHTML = (parseFloat(entityInfo.voltagem_THD_B)) ? (parseFloat(entityInfo.voltagem_THD_B).toFixed(2)+" V") : "n/a";
                sensorESP_voltagemTHDC.innerHTML = (parseFloat(entityInfo.voltagem_THD_C)) ? (parseFloat(entityInfo.voltagem_THD_C).toFixed(2)+" V") : "n/a";
