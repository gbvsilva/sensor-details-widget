    ...
    var SensorDetails = function SensorDetails() {
        ...
        var showStatusFromFieldElement = (current_status) => {
            ...
            if (entityInfo.type === "Sensor") {
                ...
                sensorESP_correnteA.innerHTML = (parseFloat(entityInfo.corrente_a)) ? (parseFloat(entityInfo.corrente_a).toFixed(2)+" A") : "n/a";
                sensorESP_correnteB.innerHTML = (parseFloat(entityInfo.corrente_b)) ? (parseFloat(entityInfo.corrente_b).toFixed(2)+" A") : "n/a";
                sensorESP_correnteC.innerHTML = (parseFloat(entityInfo.corrente_c)) ? (parseFloat(entityInfo.corrente_c).toFixed(2)+" A") : "n/a";
                sensorESP_correnteTHDA.innerHTML = (parseFloat(entityInfo.current_THD_A)) ? (parseFloat(entityInfo.current_THD_A).toFixed(2)+" %") : "n/a";
                sensorESP_correnteTHDB.innerHTML = (parseFloat(entityInfo.current_THD_B)) ? (parseFloat(entityInfo.current_THD_B).toFixed(2)+" %") : "n/a";
                sensorESP_correnteTHDC.innerHTML = (parseFloat(entityInfo.current_THD_C)) ? (parseFloat(entityInfo.current_THD_C).toFixed(2)+" %") : "n/a";
                sensorESP_potencia_ativaA.innerHTML = (parseFloat(entityInfo.power_active_a)) ? (parseFloat(entityInfo.power_active_a).toFixed(2)+" W") : "n/a";
                sensorESP_potencia_ativaB.innerHTML = (parseFloat(entityInfo.power_active_b)) ? (parseFloat(entityInfo.power_active_b).toFixed(2)+" W") : "n/a";
                sensorESP_potencia_ativaC.innerHTML = (parseFloat(entityInfo.power_active_c)) ? (parseFloat(entityInfo.power_active_c).toFixed(2)+" W") : "n/a";
                sensorESP_potencia_reativaA.innerHTML = (parseFloat(entityInfo.power_reactive_A)) ? (parseFloat(entityInfo.power_reactive_A).toFixed(2)+" VAr") : "n/a";
                sensorESP_potencia_reativaB.innerHTML = (parseFloat(entityInfo.power_reactive_B)) ? (parseFloat(entityInfo.power_reactive_B).toFixed(2)+" VAr") : "n/a";
                sensorESP_potencia_reativaC.innerHTML = (parseFloat(entityInfo.power_reactive_C)) ? (parseFloat(entityInfo.power_reactive_C).toFixed(2)+" VAr") : "n/a";
                sensorESP_potencia_aparenteA.innerHTML = (parseFloat(entityInfo.power_apparent_A)) ? (parseFloat(entityInfo.power_apparent_A).toFixed(2)+" VA") : "n/a";
                sensorESP_potencia_aparenteB.innerHTML = (parseFloat(entityInfo.power_apparent_B)) ? (parseFloat(entityInfo.power_apparent_B).toFixed(2)+" VA") : "n/a";
                sensorESP_potencia_aparenteC.innerHTML = (parseFloat(entityInfo.power_apparent_C)) ? (parseFloat(entityInfo.power_apparent_C).toFixed(2)+" VA") : "n/a";
                sensorESP_fator_potenciaA.innerHTML = (parseFloat(entityInfo.power_factor_A)) ? (parseFloat(entityInfo.power_factor_A).toFixed(2)) : "n/a";
                sensorESP_fator_potenciaB.innerHTML = (parseFloat(entityInfo.power_factor_B)) ? (parseFloat(entityInfo.power_factor_B).toFixed(2)) : "n/a";
                sensorESP_fator_potenciaC.innerHTML = (parseFloat(entityInfo.power_factor_C)) ? (parseFloat(entityInfo.power_factor_C).toFixed(2)) : "n/a";
                sensorESP_periodoA.innerHTML = (parseFloat(entityInfo.periodo_A)) ? (parseFloat(entityInfo.periodo_A).toFixed(2)+" Hz") : "n/a";
                sensorESP_periodoB.innerHTML = (parseFloat(entityInfo.periodo_B)) ? (parseFloat(entityInfo.periodo_B).toFixed(2)+" Hz") : "n/a";
                sensorESP_periodoC.innerHTML = (parseFloat(entityInfo.periodo_C)) ? (parseFloat(entityInfo.periodo_C).toFixed(2)+" Hz") : "n/a";
                sensorESP_voltagemA.innerHTML = (parseFloat(entityInfo.voltagem_a)) ? (parseFloat(entityInfo.voltagem_a).toFixed(2)+" V") : "n/a";
                sensorESP_voltagemB.innerHTML = (parseFloat(entityInfo.voltagem_b)) ? (parseFloat(entityInfo.voltagem_b).toFixed(2)+" V") : "n/a";
                sensorESP_voltagemC.innerHTML = (parseFloat(entityInfo.voltagem_c)) ? (parseFloat(entityInfo.voltagem_c).toFixed(2)+" V") : "n/a";
                sensorESP_voltagemTHDA.innerHTML = (parseFloat(entityInfo.voltagem_THD_A)) ? (parseFloat(entityInfo.voltagem_THD_A).toFixed(2)+" %") : "n/a";
                sensorESP_voltagemTHDB.innerHTML = (parseFloat(entityInfo.voltagem_THD_B)) ? (parseFloat(entityInfo.voltagem_THD_B).toFixed(2)+" %") : "n/a";
                sensorESP_voltagemTHDC.innerHTML = (parseFloat(entityInfo.voltagem_THD_C)) ? (parseFloat(entityInfo.voltagem_THD_C).toFixed(2)+" %") : "n/a";
                sensorESP_anguloAB.innerHTML = (parseFloat(entityInfo.angle_a_b)) ? (parseFloat(entityInfo.angle_a_b).toFixed(2)+" &deg") : "n/a";
                sensorESP_anguloAC.innerHTML = (parseFloat(entityInfo.angle_a_c)) ? (parseFloat(entityInfo.angle_a_c).toFixed(2)+" &deg") : "n/a";
                sensorESP_anguloBC.innerHTML = (parseFloat(entityInfo.angle_b_c)) ? (parseFloat(entityInfo.angle_b_c).toFixed(2)+" &deg") : "n/a";
